...
const TR_CONTENT: LandingContent = {
  hero: {
    ...
    defaultSelectionLabel: "Hızlı sponsor seçenekleri",
    stats: {
      label: "Bu ay yuva bulan can",
      value: 18,
      suffix: "",
    },
    quickActions: [
      {
        id: "adopt-pack",
        label: "Paketten sahiplen",
        caption: "Uçuşa hazır patileri incele",
        href: "#adopt",
        icon: "adopt",
      },
      {
        id: "sponsor-meal",
        label: "Bu gecenin mamalarını sponsorla",
        caption: "£8 ilaç + mama karşılar",
        href: CTA_PRIMARY,
        icon: "sponsor",
      },
      {
        id: "plan-visit",
        label: "Barınağı ziyaret et",
        caption: "Fethiye ekibiyle tanış ya da uçuş refakatçisi ol",
    ...
    media: {
      ...
      alt: "Kameraya bakan kurtarılan köpekler",
    },
    liveCounter: {
    ...
    urgency: {
      ...
      remainingValue: "7",
      goalLabel: "Uçuş fonu %73 tamam",
      goalPercent: 73,
      footer: "Pazar gecesi öncesi son veteriner adımlarını sponsorla.",
    },
    recurringHint: "Aylık sponsor ol, kurtarma hattı hiç durmasın.",
    ticker: {
